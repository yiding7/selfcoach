...
| 馆 | 动作 | 变换 | 记录怎么记 |
|---|---|---|---|
| BA | 直杆绳索下压 / 绳索臂屈伸 / 面拉 | `×1`（实测 1:1） | 照抄配重片读数 |
| BA | 腿举 | `+53`（机身标 118lbs） | 只记片重 |
| BA | 哈克机深蹲 | `+57`（机身标） | 只记片重 |

**其余馆、其余动作还没测。** 绳索下次去顺手数一下行程（手移动距离 ÷ 配重片
上升距离，30 秒）；哈克/腿举看机身有没有印 start。回来补一条规则就行。
